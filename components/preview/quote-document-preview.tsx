...
const dict = {
  ...
  ar: {
    ...
    h1: 'عرض السعر الشهري',
    sub: 'تسعير شفّاف ومبوّب: تدفع مقابل المخرجات الفعلية — تصميم وفيديو ومحتوى وإعلانات — ثم طبقة إدارة واحدة بنسبة 20% تغطّي الاستراتيجية والعلامة والإعلان الرقمي والاستشارات.',
    ...
    designs: 'التصميمات والمحتوى المرئي',
    designsNote: 'منشورات التواصل الاجتماعي والإعلانات والمرئيات — التسعير متدرّج حسب الكمية.',
    videos: 'مونتاج الفيديو',
    videosNote: 'مونتاج مقاطع الريلز والإعلانات. الكميات الكبيرة بسعر مخصّص.',
    content: 'المحتوى — سكريبتات وخطة',
    contentNote: 'خطة محتوى شهرية وسكريبتات. مبلغ ثابت.',
    ads: 'ميزانية الإعلانات',
    adsNote: 'تُحوَّل إلى المنصات (Meta/Google) 100% — ولا نضيف عليها أي هامش.',
    web: 'مواقع وتطبيقات وأنظمة',
    webNote: 'يُحدَّد سعرها وتطويرها بعد اجتماع تحديد النطاق. ليست جزءًا من الاشتراك الشهري.',
    subtotal: 'الإجمالي الفرعي',
    mgmt: 'الإدارة (20%)',
    mgmtNote: 'استراتيجية وعلامة وإعلان رقمي واستشارات — محسوبة على إجمالي مدفوعات الشهر.',
    ...
    notesTitle: 'ملاحظات',
    notes: [
      'لا رسوم مخفية. الرقم أعلاه هو ما تدفعه.',
      'ميزانية الإعلانات 100% لصالحكم — تُحوَّل إلى المنصات مباشرةً.',
      'الإدارة طبقة واحدة 20% على إجمالي المدفوعات.',
      'الأرقام تقديرية بناءً على الكميات المختارة. تُؤكَّد القيم النهائية في اجتماع.',
    ],
    payRows: [
      { tag: 'حسب التوفّر', sub: 'يُستحسن بداية الشهر', name: 'ميزانية الإعلانات (100%)', desc: 'تُدفع حسب التوفّر، ويُستحسن أن تكون في بداية الشهر لضمان استمرار الحملات دون انقطاع. تُحوَّل مباشرةً إلى المنصات (Meta/Google). الحدّ الأدنى ٣٠٬٠٠٠ ج.م/شهر، والمبلغ بالكامل لصالحكم ولا نضيف عليه أي هامش.' },
      { tag: 'كل أسبوعين', sub: 'أو بداية الشهر', name: 'خطة المحتوى والسكريبتات', desc: 'تُدفع كل أسبوعين، أو في بداية الشهر — وفق ما يناسبكم. القيمة ٢٬٥٠٠ ج.م شهريًا مقابل خطة المحتوى والسكريبتات.' },
      { tag: 'أسبوعيًا', sub: 'نهاية كل أسبوع', name: 'التصميمات والفيديوهات', desc: 'فوترة أسبوعية وفق ما سُلِّم فعليًا خلال الأسبوع — تدفع مقابل عمل منجز بين يديك، لا مقدّمًا.' },
      { tag: 'مع فاتورة الشهر', sub: '20%', name: 'الإدارة والعلامة والإعلان الرقمي والاستشارات', desc: 'نسبة ٢٠٪ محسوبة على إجمالي مدفوعات الشهر (بما فيها ميزانية الإعلانات) — رقم واحد واضح، ونحن مسؤولون تمامًا عن النتائج.' },
      { tag: 'دفعات المشروع', sub: 'عند الحاجة', name: 'المواقع والتطبيقات والأنظمة', desc: 'تُسعَّر وتُدفع منفصلةً على دفعات حسب مراحل المشروع (مثلًا ٥٠٪ عند البدء / ٥٠٪ عند التسليم) — بعد اجتماع لتحديد النطاق. ليست جزءًا من الاشتراك الشهري.' },
    ],
  },
} as const;
