  ...
  return (
    <aside className="hidden lg:flex w-64 shrink-0 flex-col border-r border-white/5 bg-black/60 backdrop-blur-md no-print">
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-5 space-y-6">
        <div>
          <div className="px-2 mb-2 text-[11px] uppercase tracking-wider text-zinc-500 font-medium">
            Overview
          </div>
      ...
      <div className="px-3 pb-3 space-y-2">
        {BACK_TILES.map((tile) => (
          ...
          >
            <div className="text-[12px] uppercase tracking-wider text-zinc-400">Back to</div>
            <div className="mt-1 flex items-center justify-between text-[15px] text-white">
  ...
  return (
    <li>
      <Link
        href={item.href}
        className={cn(
          'flex items-center gap-2.5 rounded-md px-2.5 py-2 text-[15px] transition-colors ring-focus',
          active
